      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            _context2.next = 6;
            return fetch("https://api.openweathermap.org/data/2.5/weather?lat=".concat(geoCode.lat, "&lon=").concat(geoCode.lon, "&APPID=07635fa17157cfd961af367e15eeb273"), {
              mode: "cors"
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = console;
            _context.next = 3;
            return (0,_APIHandler__WEBPACK_IMPORTED_MODULE_3__.weatherSearch)("97330");
